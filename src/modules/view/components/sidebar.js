const sidebar = {
  ...
  renderSidebar(projects, onProjectClick) {
    ...
    const sidebarX = document.createElementNS(
    ...
    const userProfileSvg = document.createElementNS(
      'http://www.w3.org/2000/svg',
      'svg'
    );
    ...
    const userSelectArrow = document.createElementNS(
      'http://www.w3.org/2000/svg',
      'svg'
    );
    ...
    const tasksSvg = document.createElementNS(
      'http://www.w3.org/2000/svg',
      'svg'
    );
    ...
    const tasksArrow = document.createElementNS(
      'http://www.w3.org/2000/svg',
      'svg'
    );
    ...
    const nestedOptions = [
      ...
      {
        id: 'in-progress-tasks-menu-option',
        text: 'In Progress',
        svg: `
      ...
      {
        id: 'completed-tasks-menu-option',
        text: 'Completed',
        svg: `
    ...
    tasksLink.addEventListener('click', (e) => {
      ...
      if (isNestedVisible) {
        ...
        console.log(
          'Expanding nested menu, setting maxHeight to:',
          nestedHeight
        );
    ...
    const settingsSvg = document.createElementNS(
      'http://www.w3.org/2000/svg',
      'svg'
    );
    ...
    const logoutSvg = document.createElementNS(
      'http://www.w3.org/2000/svg',
      'svg'
    );
